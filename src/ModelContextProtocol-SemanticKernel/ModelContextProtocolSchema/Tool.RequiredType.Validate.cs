                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    if (property.NameEquals(JsonPropertyNames.PropertiesUtf8, JsonPropertyNames.Properties))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType.PropertiesEntity>().Validate(result.CreateChildContext(), level);
                    ...
                    else if (property.NameEquals(JsonPropertyNames.RequiredUtf8, JsonPropertyNames.Required))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType.JsonStringArray>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
                    ...
                    else if (property.NameEquals(JsonPropertyNames.TypeUtf8, JsonPropertyNames.Type))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType.TypeEntity>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
