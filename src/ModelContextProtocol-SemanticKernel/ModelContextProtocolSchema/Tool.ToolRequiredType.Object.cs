...
public readonly partial struct Tool
{
    ...
    public readonly partial struct ToolRequiredType
        : IJsonObject<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType>
    {
        /// <summary>
        /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ToolRequiredType(ImmutableList<JsonObjectProperty> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonObjectProperty>(ToolRequiredType value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ToolRequiredType(JsonObject value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonObject(ToolRequiredType value)
        {
            return
                value.AsObject;
        }
        ...
        /// </summary>
        public ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType.PropertiesEntity Properties
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType.PropertiesEntity>();
                    }
                }
        ...
        /// </summary>
        public ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType.JsonStringArray Required
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType.JsonStringArray>();
                    }
                }
        ...
        /// </para>
        /// </remarks>
        public ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType.TypeEntity Type
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType.TypeEntity>();
                    }
                }
        ...
        /// <inheritdoc/>
        public static ToolRequiredType FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
            return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
        }

        /// <inheritdoc/>
        public static ToolRequiredType FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        public static ToolRequiredType FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }

        /// <summary>
        /// Creates an instance of a <see cref="ToolRequiredType"/>.
        /// </summary>
        public static ToolRequiredType Create(in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType.PropertiesEntity? properties = null, in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType.JsonStringArray? required = null)
        {
            var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
            builder.Add(JsonPropertyNames.Type, ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType.TypeEntity.ConstInstance.AsAny);
        ...
        public ToolRequiredType WithProperties(in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType.PropertiesEntity value)
        {
        ...
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public ToolRequiredType WithRequired(in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType.JsonStringArray value)
        {
        ...
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public ToolRequiredType WithType(in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType.TypeEntity value)
        {
        ...
        /// <inheritdoc />
        public ToolRequiredType SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc />
        public ToolRequiredType RemoveProperty(in JsonPropertyName name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public ToolRequiredType RemoveProperty(string name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public ToolRequiredType RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public ToolRequiredType RemoveProperty(ReadOnlySpan<byte> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }
        ...
        private static class __CorvusObjectHelpers
        {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in ToolRequiredType that)
            {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ToolRequiredType that, in JsonPropertyName name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ToolRequiredType that, ReadOnlySpan<char> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ToolRequiredType that, ReadOnlySpan<byte> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ToolRequiredType that, string name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in ToolRequiredType that, in JsonPropertyName name, in JsonAny value)
            {
                if ((that.backing & Backing.Object) != 0)
                {
