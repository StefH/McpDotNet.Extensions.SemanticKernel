...
public readonly partial struct Tool
    : IJsonObject<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool>
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.ToolAnnotations Annotations
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.ToolAnnotations>();
                }
            }
    ...
    /// </para>
    /// </remarks>
    public ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType InputSchema
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType>();
                }
            }
    ...
    /// </para>
    /// </remarks>
    public ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType OutputSchema
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType>();
                }
            }
    ...
    public static Tool Create(
        in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType inputSchema,
        in Corvus.Json.JsonString name,
        in Corvus.Json.JsonObject? meta = null,
        in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.ToolAnnotations? annotations = null,
        in Corvus.Json.JsonString? description = null,
        in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType? outputSchema = null,
    ...
    /// </para>
    /// </remarks>
    public Tool WithAnnotations(in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.ToolAnnotations value)
    {
    ...
    /// </para>
    /// </remarks>
    public Tool WithInputSchema(in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType value)
    {
    ...
    /// </para>
    /// </remarks>
    public Tool WithOutputSchema(in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType value)
    {
