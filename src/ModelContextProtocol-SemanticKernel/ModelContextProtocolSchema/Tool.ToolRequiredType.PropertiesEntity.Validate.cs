        ...
        public readonly partial struct PropertiesEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("#/definitions/Tool/properties/outputSchema/properties/properties");
                }
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    int propertyCount = 0;
                    foreach (JsonObjectProperty<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.ToolRequiredType.PropertiesEntity.AdditionalPropertiesEntity> property in value.EnumerateObject())
                    {
