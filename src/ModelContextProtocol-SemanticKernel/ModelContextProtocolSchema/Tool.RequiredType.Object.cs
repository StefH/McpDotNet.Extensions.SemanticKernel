...
public readonly partial struct Tool
{
    ...
    public readonly partial struct RequiredType
        : IJsonObject<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType>
    {
        /// <summary>
        ...
        /// </summary>
        public ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType.PropertiesEntity Properties
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType.PropertiesEntity>();
                    }
                }
        ...
        /// </summary>
        public ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType.JsonStringArray Required
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType.JsonStringArray>();
                    }
                }
        ...
        /// </para>
        /// </remarks>
        public ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType.TypeEntity Type
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType.TypeEntity>();
                    }
                }
        ...
        /// </summary>
        public static RequiredType Create(in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType.PropertiesEntity? properties = null, in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType.JsonStringArray? required = null)
        {
            var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
            builder.Add(JsonPropertyNames.Type, ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType.TypeEntity.ConstInstance.AsAny);
        ...
        public RequiredType WithProperties(in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType.PropertiesEntity value)
        {
        ...
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public RequiredType WithRequired(in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType.JsonStringArray value)
        {
        ...
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public RequiredType WithType(in ModelContextProtocol.SemanticKernel.ModelContextProtocolSchema.Tool.RequiredType.TypeEntity value)
        {
