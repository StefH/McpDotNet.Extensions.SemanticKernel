...
public readonly partial struct Tool
{
    ...
    public readonly partial struct ToolRequiredType
        : IJsonObject<ModelContextProtocol.Schema.Tool.ToolRequiredType>
    {
        /// <summary>
        ...
        /// </summary>
        public ModelContextProtocol.Schema.Tool.ToolRequiredType.PropertiesEntity Properties
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<ModelContextProtocol.Schema.Tool.ToolRequiredType.PropertiesEntity>();
                    }
                }
        ...
        /// </summary>
        public ModelContextProtocol.Schema.Tool.ToolRequiredType.JsonStringArray Required
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<ModelContextProtocol.Schema.Tool.ToolRequiredType.JsonStringArray>();
                    }
                }
        ...
        /// </para>
        /// </remarks>
        public ModelContextProtocol.Schema.Tool.ToolRequiredType.TypeEntity Type
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<ModelContextProtocol.Schema.Tool.ToolRequiredType.TypeEntity>();
                    }
                }
        ...
        /// </summary>
        public static ToolRequiredType Create(in ModelContextProtocol.Schema.Tool.ToolRequiredType.PropertiesEntity? properties = null, in ModelContextProtocol.Schema.Tool.ToolRequiredType.JsonStringArray? required = null)
        {
            var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
            builder.Add(JsonPropertyNames.Type, ModelContextProtocol.Schema.Tool.ToolRequiredType.TypeEntity.ConstInstance.AsAny);
        ...
        public ToolRequiredType WithProperties(in ModelContextProtocol.Schema.Tool.ToolRequiredType.PropertiesEntity value)
        {
        ...
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public ToolRequiredType WithRequired(in ModelContextProtocol.Schema.Tool.ToolRequiredType.JsonStringArray value)
        {
        ...
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public ToolRequiredType WithType(in ModelContextProtocol.Schema.Tool.ToolRequiredType.TypeEntity value)
        {
