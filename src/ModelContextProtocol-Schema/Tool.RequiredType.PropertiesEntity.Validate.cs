        ...
        public readonly partial struct PropertiesEntity
        {
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    int propertyCount = 0;
                    foreach (JsonObjectProperty<ModelContextProtocol.Schema.Tool.RequiredType.PropertiesEntity.AdditionalPropertiesEntity> property in value.EnumerateObject())
                    {
