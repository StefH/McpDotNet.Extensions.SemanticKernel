...
using var wireMockServer = InitWireMockServer();
...
static WireMockServer InitWireMockServer()
{
    ...
    var searchRepositoriesResponse =
        """
        {"result":{"content":[{"type":"text","text":"{\n  \"total_count\": 1,\n  \"incomplete_results\": false,\n  \"items\": [\n    {\n      \"id\": 387261449,\n      \"node_id\": \"MDEwOlJlcG9zaXRvcnkzODcyNjE0NDk=\",\n      \"name\": \"FluentBuilder\",\n      \"full_name\": \"StefH/FluentBuilder\",\n      \"private\": false,\n      \"owner\": {\n        \"login\": \"StefH\",\n        \"id\": 249938,\n        \"node_id\": \"MDQ6VXNlcjI0OTkzOA==\",\n        \"avatar_url\": \"https://avatars.githubusercontent.com/u/249938?v=4\",\n        \"url\": \"https://api.github.com/users/StefH\",\n        \"html_url\": \"https://github.com/StefH\",\n        \"type\": \"User\"\n      },\n      \"html_url\": \"https://github.com/StefH/FluentBuilder\",\n      \"description\": \"A project which uses Source Generation to create a FluentBuilder for a specified model or DTO\",\n      \"fork\": false,\n      \"url\": \"https://api.github.com/repos/StefH/FluentBuilder\",\n      \"created_at\": \"2021-07-18T20:15:29Z\",\n      \"updated_at\": \"2025-02-20T22:26:59Z\",\n      \"pushed_at\": \"2025-03-11T17:51:47Z\",\n      \"git_url\": \"git://github.com/StefH/FluentBuilder.git\",\n      \"ssh_url\": \"git@github.com:StefH/FluentBuilder.git\",\n      \"clone_url\": \"https://github.com/StefH/FluentBuilder.git\",\n      \"default_branch\": \"main\"\n    }\n  ]\n}"}]},"jsonrpc":"2.0","id":5}
        """;
    ...
    server
        ...
        .ThenRespondWith(r => r
            ...
            .WithBody(async reqMsg =>
            {
                ...
                await tscListCommits.Task;
                if (!commitsSent)
                {
                    commitsSent = true;
                    return $"event: message\r\ndata: {listCommitsResponse}\r\n\r\n";
                }

                await tscSearchRepositories.Task;
                if (!searchRepositoriesSent)
                {
                    searchRepositoriesSent = true;
    ...
    server
        .WhenRequest(r => r
            ...
            .WithBody("{\"jsonrpc\":\"2.0\",\"id\":2,\"method\":\"initialize\",\"params\":{\"protocolVersion\":\"2024-11-05\",\"capabilities\":{},\"clientInfo\":{\"name\":\"GitHub sseClient\",\"version\":\"1.0.0\"}}}")
        )
        .ThenRespondWith(r => r
            .WithHeader("Content-Type", "application/json")
    ...
    server
        .WhenRequest(r => r
            .UsingPost()
            .WithPath("/sse")
            .WithBody("{\"jsonrpc\":\"2.0\",\"id\":4,\"method\":\"tools/call\",\"params\":{\"name\":\"list_commits\",\"arguments\":{\"owner\":\"StefH\",\"repo\":\"FluentBuilder\",\"perPage\":1}}}")
        )
        .ThenRespondWith(r => r
            .WithBody(reqMsg =>
            {
    ...
    server
        .WhenRequest(r => r
            .UsingPost()
            .WithPath("/sse")
            .WithBody("{\"jsonrpc\":\"2.0\",\"id\":5,\"method\":\"tools/call\",\"params\":{\"name\":\"search_repositories\",\"arguments\":{\"query\":\"StefH/FluentBuilder\"}}}")
        )
        .ThenRespondWith(r => r
            .WithBody(reqMsg =>
            {
                tscSearchRepositories.SetResult();
                return "accepted";
            })
        );
